...
面向大型央企集团（中央企业集团）的"穿透式监管平台"，以"一平台三中心"为顶层架构，覆盖**全级次组织、全链条业务、全过程时间、全要素对象**四大穿透维度，落地**十大监管领域、11+N 项重大风险**的实时识别、告警、核查、处置、归档全闭环。本前端工程是该平台的管理后台，对接 5 年落地实操方案中规划的浪潮 iGIX、司库系统等后端能力（本期以 Mock 数据呈现），供集团及二级、三级单位监管人员日常使用。
